...
def main(args):
    ...
    ckpt_path = best_models_folder / f'best_model_metric_{metric_name}-macro.pth'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test-split', default='all', help='split to be used for evaluation')
